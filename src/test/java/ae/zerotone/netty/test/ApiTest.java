...
public class ApiTest {
  ...
  /**
   * “r”：以只读的方式打开，调用该对象的任何write（写）方法都会导致IOException异常 “rw”：以读、写方式打开，支持文件的读取或写入。若文件不存在，则创建
   ...
   *
   * <p>https://docs.oracle.com/javase/7/docs/api/java/io/RandomAccessFile.html
   */
