...
import ae.zerotone.netty.domain.*;
...
public class MsgUtil {
   ...
   * @return 传输协议
   */
  public static FileTransferProtocol buildRequestTransferFile(
    ...
    fileTransferProtocol.setTransferType(Constants.TransferType.REQUEST); // 0请求传输文件、1文件传输指令、2文件传输数据
   ...
   * @return 传输协议
   */
  public static FileTransferProtocol buildTransferInstruct(
      Integer status, String clientFileUrl, Integer readPosition) {
  ...
  public static FileTransferProtocol buildTransferInstruct(FileBurstInstruct fileBurstInstruct) {
    FileTransferProtocol fileTransferProtocol = new FileTransferProtocol();
    fileTransferProtocol.setTransferType(
        Constants.TransferType.INSTRUCT); // 0传输文件'请求'、1文件传输'指令'、2文件传输'数据'
  ...
  public static FileTransferProtocol buildTransferData(FileBurstData fileBurstData) {
    FileTransferProtocol fileTransferProtocol = new FileTransferProtocol();
    fileTransferProtocol.setTransferType(
        Constants.TransferType.DATA); // 0传输文件'请求'、1文件传输'指令'、2文件传输'数据'
